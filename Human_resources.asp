...
select case act
   case "yrln"
   sql="select * from qy_info where q_type='yrln'"
   i_title="用人理念"
   n_class0="current"
   case "fldy"
   sql="select * from qy_info where q_type='fldy'"
   i_title="福利待遇"
   n_class1="current"
   case "zpxx"
   sql="select * from qy_job order by j_time desc"
   i_title="招聘信息"
   n_class2="current"
 end select
%>
...
<div class="class_nav">
<ul>
<li><a href="Human_resources.asp?act=yrln"  onclick="change_bg(this)" class=<%=n_class0%> >用人理念</a></li>
<li><a href="Human_resources.asp?act=fldy" onclick="change_bg(this)" class=<%=n_class1%> >福利待遇</a></li>
<li><a href="Human_resources.asp?act=zpxx"  onclick="change_bg(this)" class=<%=n_class2%> >招聘信息</a></li>
</ul>
</div>
<!--end class_nav-->
</div>
