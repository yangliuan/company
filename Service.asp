...
<%
showSystem()
dim act,sql,i_title,n_class0,n_class1,content,m_time
...
select case act
   case "message"
   sql="select * from qy_msg where m_check=true"
   i_title="给我们留言"
   n_class0="current"
   case "contact"
   sql="select * from qy_info where q_type='lxwm'"
   i_title="联系我们"
   n_class1="current"
end select
SendMessage()
...
<div id="layout">
  <div id="top">
    ...
    <!--end logo-->
    <div id="top_menu">
      <div id="top_menu_boder"> <a href="#"><span></span>English&nbsp;&nbsp;</a> <a href="#"><span></span>加盟我们&nbsp;</a> <a href="#"><span></span>其它子公司</a></div>
    </div>
    <!--end top_menu-->
    <div id="top_nav"> <a href="About_us.asp?act=qywh"><img src="image/tnav_1.png"  class="tnav_1" /></a> <a href="About_us.asp?act=ryzz"><img src="image/tnav_2.png"  class="tnav_2" /></a> <a href="Products.asp"><img src="image/tnav_3.png"  class="tnav_3" /></a> <a href="Human_resources.asp?act=zpxx"><img src="image/tnav_4.png"  class="tnav_4" /></a> <a href="Service.asp?act=contact"><img src="image/tnav_5.png"  class="tnav_5" /></a>
...
<h1>&nbsp;&nbsp;客服中心<span id="title">首页>关于我们><%=i_title%></span></h1>
<div class="class_nav">
<ul>
<li><a href="Service.asp?act=message"  onclick="change_bg(this)" class=<%=n_class0%> >给我们留言</a></li>
<li><a href="Service.asp?act=contact" onclick="change_bg(this)" class=<%=n_class1%> >联系我们</a></li>
</ul>
</div>
<!--end class_nav-->
</div>
